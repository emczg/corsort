#!/usr/bin/env python
#
# corsort documentation build configuration file, created by
...
project = 'Corsort'
copyright = "2023, Emma Caizergues"
...
version = corsort.__version__
# The full version, including alpha/beta/rc tags.
release = corsort.__version__
...
latex_documents = [
    (master_doc, 'corsort.tex',
     'Corsort Documentation',
     'Emma Caizergues', 'manual'),
]
